...
g0 = 0.0
Nlink0 = 1
mech = getmechanism(:snake, Δt = Δt0, g = g0, Nlink = Nlink0, spring = 0.0, damper = 0.0,
    jointtype = :Spherical, contact = false)


mech.bodies[2].J = Array(Diagonal([1.0, 2.0, 3.0]))
ϕ0 = 0.0
v0 = 0.0 * [-0.1,0.5,0.2]
ω0 = 0.1 * [1,2,3.0]
Δv0 = zeros(3)
Δω0 = 0.0 * [3,-2,3.0] / Nlink0
...
function getmomentum(t::T) where T
    mechanism = getmechanism(:snake, Δt = Δt0, g = g0, Nlink = Nlink0, spring = 0.0, damper = 0.0,
        jointtype = :Spherical, contact = false)
