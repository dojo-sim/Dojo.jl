@testset "FiniteDiff comparison" begin
    ...
    @test norm(FD∂i∂v - Dojo.linear_integrator_jacobian_velocity(timestep0), Inf) < 1.0e-6
    # ∇ϕ
    ...
    @test norm(FDvel - Dojo.integrator_jacobian_velocity(q0, ϕ0, timestep0), Inf) < 1.0e-6
