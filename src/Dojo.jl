...
include(joinpath("contacts", "soft", "soft_contact.jl"))
include(joinpath("contacts", "soft", "soft_halfspace.jl"))
include(joinpath("contacts", "soft", "soft_sphere.jl"))
include(joinpath("contacts", "soft", "soft_soft.jl"))
include(joinpath("contacts", "soft", "soft_constraints.jl"))
include(joinpath("contacts", "soft", "soft_data.jl"))
include(joinpath("contacts", "soft", "normalizer.jl"))
