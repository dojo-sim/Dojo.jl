...
@inline function minimalCoordinates(joint::Translational, body1::Node, body2::Node)
    statea = body1.state
    stateb = body2.state
...
@inline function minimalVelocities(joint::Translational, body1::Node, body2::Node)
    statea = body1.state
    stateb = body2.state
