...
# # end
# #
# # @inline function constraint_jacobian_parent(joint::Rotational{T,Nλ,Nb,N}, xa::AbstractVector,
# #         qa::UnitQuaternion, xb::AbstractVector, qb::UnitQuaternion, η) where {T,Nλ,Nb,N}
# #     X = szeros(T, N, 3)
...
# # end
# #
# # @inline function constraint_jacobian_child(joint::Rotational{T,Nλ,Nb,N}, xa::AbstractVector,
# #         qa::UnitQuaternion, xb::AbstractVector, qb::UnitQuaternion, η) where {T,Nλ,Nb,N}
# #     X = szeros(T, N, 3)
