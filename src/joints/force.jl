...
springforcea(joint::Translational3{T}, statea::State, stateb::State, Δt) where {T} = szeros(T, 6)
springforceb(joint::Translational3{T}, statea::State, stateb::State, Δt) where {T} = szeros(T, 6)
springforceb(joint::Translational3{T}, stateb::State, Δt) where {T} = szeros(T, 6)
damperforcea(joint::Translational3{T}, statea::State, stateb::State, Δt) where {T} = szeros(T, 6)
damperforceb(joint::Translational3{T}, statea::State, stateb::State, Δt) where {T} = szeros(T, 6)
damperforceb(joint::Translational3{T}, stateb::State, Δt) where {T} = szeros(T, 6)
...
∂springforcea∂posa(joint::Translational3{T}, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂damperforcea∂posa(joint::Translational3{T}, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂springforcea∂posb(joint::Translational3{T}, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂damperforcea∂posb(joint::Translational3{T}, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂springforceb∂posb(joint::Translational3{T}, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂damperforceb∂posb(joint::Translational3{T}, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂springforceb∂posa(joint::Translational3{T}, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂damperforceb∂posa(joint::Translational3{T}, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂springforceb∂posb(joint::Translational3{T}, body1::Origin, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)
∂damperforceb∂posb(joint::Translational3{T}, body1::Origin, body2::Body, Δt::T; attjac::Bool = true) where T = attjac ? szeros(T, 6, 6) : szeros(T, 6, 7)

∂springforcea∂vela(joint::Translational3{T}, body1::Body, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂damperforcea∂vela(joint::Translational3{T}, body1::Body, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂springforcea∂velb(joint::Translational3{T}, body1::Body, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂damperforcea∂velb(joint::Translational3{T}, body1::Body, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂springforceb∂velb(joint::Translational3{T}, body1::Body, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂damperforceb∂velb(joint::Translational3{T}, body1::Body, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂springforceb∂vela(joint::Translational3{T}, body1::Body, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂damperforceb∂vela(joint::Translational3{T}, body1::Body, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂springforceb∂velb(joint::Translational3{T}, body1::Origin, body2::Body, Δt::T) where T = szeros(T, 6, 6)
∂damperforceb∂velb(joint::Translational3{T}, body1::Origin, body2::Body, Δt::T) where T = szeros(T, 6, 6)

function ∂springforcea∂posa(joint::Translational, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T
...
function ∂damperforcea∂posa(joint::Translational, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T
    xa, qa = posargs2(body1.state)
    xb, qb = posargs2(body2.state)
...
function ∂springforcea∂posb(joint::Translational, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T
    xa, qa = posargs2(body1.state)
    xb, qb = posargs2(body2.state)
...
function ∂damperforcea∂posb(joint::Translational, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T
    xa, qa = posargs2(body1.state)
    xb, qb = posargs2(body2.state)
    va = body1.state.vsol[2]
    vb = body2.state.vsol[2]
...
function ∂springforceb∂posb(joint::Translational, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T
    xa, qa = posargs2(body1.state)
    xb, qb = posargs2(body2.state)
...
function ∂damperforceb∂posb(joint::Translational, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T
    xa, qa = posargs2(body1.state)
    xb, qb = posargs2(body2.state)
    va = body1.state.vsol[2]
    vb = body2.state.vsol[2]
...
function ∂springforceb∂posa(joint::Translational, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T
    xa, qa = posargs2(body1.state)
    xb, qb = posargs2(body2.state)
...
function ∂damperforceb∂posa(joint::Translational, body1::Body, body2::Body, Δt::T; attjac::Bool = true) where T
    xa, qa = posargs2(body1.state)
    xb, qb = posargs2(body2.state)
    va = body1.state.vsol[2]
    vb = body2.state.vsol[2]
...
function ∂springforceb∂posb(joint::Translational, body1::Origin, body2::Body, Δt::T; attjac::Bool = true) where T
    xb, qb = posargs2(body2.state)
...
function ∂damperforceb∂posb(joint::Translational, body1::Origin, body2::Body, Δt::T; attjac::Bool = true) where T
    xb, qb = posargs2(body2.state)
    vb = body2.state.vsol[2]
    ωb = body2.state.ϕsol[2]
