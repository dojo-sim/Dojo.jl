...
function simulate!(mechanism::Mechanism, steps::AbstractUnitRange, storage::Storage, control!::Function;
    ...
    for k = steps
        ...
        eval(solver)(mechanism, ε = ε, newtonIter = newtonIter, lineIter = lineIter, warning = debug)
...
function simulate!(mechanism::AbstractMechanism{T}, tend::Real, args...;
    ...
    storage = simulate!(mechanism, steps, storage, args...; solver = solver, ε = ε, newtonIter = newtonIter, lineIter = lineIter, record = record, debug = debug)
