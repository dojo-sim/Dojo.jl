function getslider(; timestep::T = 0.01, g::T = -9.81, spring = 0.0, damper = 0.0) where T
    # Parameters
    joint_axis = [0; 0; 1.0]
    length1 = 1.0
    width, depth = 0.1, 0.1
...
function getnslider(; timestep::T = 0.01, g::T = -9.81, spring::T = 0.0, damper::T = 0.0, Nb::Int = 5) where T
    # Parameters
    ex = [0; 0; 1.0]
    h = 1.
    r = .05
