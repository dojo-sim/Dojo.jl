    ...
    if contact
        ...
        for name in names
            ...
            if name == :foot # need special case for foot
                ...
                push!(models, contact_constraint(body, normal, friction_coefficient=friction_coefficient, contact_point=contact_pointf, offset=o))
                push!(models, contact_constraint(body, normal, friction_coefficient=friction_coefficient, contact_point=contact_pointb, offset=o))
            else
                p = [0;0; 0.5 * body.shape.rh[2]]
                o = [0;0; body.shape.rh[1]]
                push!(models, contact_constraint(body, normal, friction_coefficient=friction_coefficient, contact_point=contact_point, offset=o))
            end
        end
