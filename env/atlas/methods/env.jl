...
function atlas(; mode::Symbol=:min, dt::T=0.01, gravity=[0.0; 0.0; -9.81], friction_coefficient=0.8,
    ...
    mechanism = get_mechanism(:atlas, timestep=dt, gravity=gravity, friction_coefficient=friction_coefficient, damper=damper,
