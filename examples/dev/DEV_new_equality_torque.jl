...
# norm((fd_datamat + datamat)[1:5, 1:13], Inf)
# norm((fd_datamat + datamat)[1:5, 1:3], Inf)
# norm((fd_datamat + datamat)[1:5, 4:6], Inf)
# norm((fd_datamat + datamat)[1:5, 7:10], Inf)
# norm((fd_datamat + datamat)[1:3, 7:10], Inf)
# norm((fd_datamat + datamat)[4:5, 7:10], Inf)
# norm((fd_datamat + datamat)[1:5, 11:13], Inf)
# norm((fd_datamat + datamat)[6:11, 1:13], Inf)
#
#
#
#
#
# norm((fd_datamat + datamat)[6:11, 1:3], Inf)
# norm((fd_datamat + datamat)[6:11, 4:6], Inf)
# norm((fd_datamat + datamat)[6:11, 7:10], Inf)
# norm((fd_datamat + datamat)[1:3, 7:10], Inf)
# norm((fd_datamat + datamat)[4:5, 7:10], Inf)
# norm((fd_datamat + datamat)[6:11, 11:13], Inf)
#
#
# norm((fd_datamat + datamat)[1:6, 1:3], Inf)
# norm((fd_datamat + datamat)[1:6, 4:6], Inf)
# norm((fd_datamat + datamat)[1:5, 7:10], Inf)
# norm((fd_datamat + datamat)[1:3, 7:10], Inf)
# norm((fd_datamat + datamat)[4:5, 7:10], Inf)
