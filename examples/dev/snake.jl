...
linmech = getmechanism(:snake, Nlink = 5, Δt = 0.02, g = -9.81, cf = 0.2, contact = false, contact_type = :linear_contact)
socmech = getmechanism(:snake, Nlink = 5, Δt = 0.02, g = -9.81, cf = 0.2, contact = false, contact_type = :contact)
