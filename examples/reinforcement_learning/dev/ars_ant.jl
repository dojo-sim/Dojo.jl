...
# env = get_environment("ant", vis=vis, representation=:minimal, g=-9.81, timestep=0.05, damper=5.0, spring=5.0, friction_coefficient = 0.5,
env = get_environment("ant", vis=vis, representation=:minimal, g=-9.81, timestep=0.05, damper=50.0, spring=30.0, friction_coefficient = 0.5,
