...
generate_dataset(:block2d, H=0.75, N=15,
...
# Load Dataset
################################################################################
params0, trajs0, pairs0 = open_dataset(:block2d; N = 15, mech_kwargs...)
...
################################################################################
clean_loss(:block2d, pairs0, data0, opts=SolverOptions(btol=3e-4, rtol=3e-4))

[clean_loss(:block2d, pairs0, data0 + [i;zeros(27)], opts=SolverOptions(btol=3e-4, rtol=3e-4))
	for i in Vector(-0.10:0.01:0.1)]
[clean_loss(:block2d, pairs0, data0 + [0;i;zeros(26)], opts=SolverOptions(btol=3e-4, rtol=3e-4))
	for i in Vector(-0.10:0.01:0.1)]
