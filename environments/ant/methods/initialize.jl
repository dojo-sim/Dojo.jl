function get_ant(; 
    ...
    if contact_feet
        ...
        contacts = [contact_constraint(foot[i], normal, friction_coefficient=friction_coefficient, contact_point=p[i], contact_radius=o[i]) for i = 1:length(foot_names)]
        ...
        if contact_body
            ...
            p = [0.0; 0.0; 0.0]
            o = torso.shape.r
            torso_contacts = contact_constraint(torso, normal, friction_coefficient=friction_coefficient, contact_point=p, contact_radius=o)
            ...
            elbow_contacts = [contact_constraint(elbow[i], normal, friction_coefficient=friction_coefficient, contact_point=p[i], contact_radius=o[i]) for i = 1:length(elbow_names)]
