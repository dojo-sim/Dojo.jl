...
mech = get_bunny(SOFT)
mech.contacts[1].model.collider.options.impact_spring = 3e3
mech.contacts[1].model.collider.options.impact_damper = 3e4
mech.contacts[1].model.collider.options.sliding_drag = 0.10
mech.contacts[1].model.collider.options.sliding_friction = 0.2
mech.contacts[1].model.collider.options.rolling_drag = 0.01
mech.contacts[1].model.collider.options.rolling_friction = 0.01
mech.contacts[1].model.collider.options.coulomb_smoothing = 3e+1
mech.contacts[1].model.collider.options.coulomb_regularizer = 1e-3
